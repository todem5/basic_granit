...
$this->registerMetaTag(['name' => 'description', 'content' => 'Оптовый склад в г.Омск: гранит шанси Китай и мрамор уфалей']);
//$this->registerMetaTag(['name' => 'keywords', 'content' => $this->params['meta_keywords'] ?? '']);
$this->registerMetaTag(['name' => 'keywords', 'content' => 'гранит, мрамор, шанси, уфалей, оптовый склад, Омск']);
//$this->title = "Главная";
$this->registerMetaTag(['name' => 'yandex-verification', 'content' => '9105ce365e5a183f']);
$this->registerMetaTag(['name' => 'mailru-domain', 'content' => 'ePuWlkgXYLJ140Q7']);
...
<body class="d-flex flex-column h-100">
    ...
    <?php
    NavBar::begin([
        'brandLabel' => '<img src="img/logo_small.png">',
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            '<a class="nav-link messengers__link--tg" href="https://t.me/+8xnxgXCvqGdhZTM6" target="_blank" title="Канал ГранитПро">
            ...
            '</li>',
            '<li class="nav-item">',
            '<a class="nav-link" href="tel:+7 913 147-7250" title="Позвонить">+7 913 147-7250</a>',
            '</li>',
            //['label' => '+7 983 523-5952', 'phone' => ['tel:+7-983-523-5952']],
        ]
    ]);
    NavBar::end();
    ?>
    ...
    <footer id="footer" class="mt-auto py-3 bg-light">
        <div class="container">
            <div class="row text-muted">
                <div class="col-md-6 text-center text-md-start">&copy; ООО "ГранитПро" <?= date('Y') ?></div>
